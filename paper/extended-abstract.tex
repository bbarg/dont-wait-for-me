...
\cite{hoare1974monitors}. A standard for conditional variables in
which the signaling threads holds the mutex while signaling was
included as an extension to the POSIX standard in 1992 and was
implemented by Mueller in 1993
\cite{ieee1992pthreads,mueller1993library}.
...
% TODO - explain how this is similar to eventcounts
Our final solution for coordinating sleeps bears a passing similarity
to event counts, which are essentially lock-free condition variables.
